  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
        ...
        py-10 border-b border-gray-500/30 text-gray-500'>
            ...
            <div>
                <img src={assets.logo} alt="logo" className='w-21 sm:w-44' />
                <p className='max-w-[410px] mt-6'>QuickBlog gives writers a simple space to explore ideas, 
                share stories openly, and write without pressure or boundaries.</p>
            </div>
